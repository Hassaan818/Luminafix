            ...
            <div class="col-lg-12">
               <div class="card card-Vertical card-default card-md mb-4">
                  ...
                  <div class="card-body py-md-30">
                     <form id="tnbn_product_form_id" method="post" action="{{ route('admin.projects.update',[$project->id])}}" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        <div class="row">
                           <div class="col-md-6 mb-25">
                              <label for="a1" class="il-gray fs-14 fw-500 align-center mb-10">Project Title</label>
                              <input type="text" name="title" value="{{ old('title', $project->title) }}" class="form-control ih-medium ip-gray radius-xs b-light px-15" placeholder="Name">
                           </div>


                           <div class="col-md-12 mb-25">
                              <label for="a1" class="il-gray fs-14 fw-500 align-center mb-10">Description</label>
                              <textarea name="description" id="mail-reply-message2" class="form-control-md" placeholder="Type your text...">{{ old('description', $project->description) }}</textarea>
                           </div>
                           <div class="col-md-6 mb-25">
                              ...
                              <div>
                                 <a href="{{ $project->getImagePath($project->image) }}" class="text-dark fw-500">
                                    <img class="ap-img__main rounded-circle wh-100 bg-lighter d-flex" src="{{ $project->getImagePath($project->image) }}" alt="profile">
                                 </a>
                              </div>
                              @endif
                           </div>
                           <div class="col-md-6 mb-25">
                              ...
                              <select name="status" class="form-control px-15" id="status_select_box">
                                 ...
                                 <option value="{{ $key }}" {{ ($status === $project->status) ? "selected" : "" }}>{{ $status}}</option>
                                 @endforeach
                              </select>
                           </div>
                           <div class="col-md-12">
